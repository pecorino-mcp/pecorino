...
for cmd in cmake ninja ccache c++; do
    if ! command -v $cmd &> /dev/null; then
        ...
        echo "  Fedora/RHEL: sudo dnf install cmake ninja-build gcc gcc-c++ ccache"
        echo "  Ubuntu/Debian: sudo apt install cmake ninja-build build-essential ccache"
...
COMPILED_SO=$(find modules/gorgonzola/build/release -name "_gorgonzola*.so" -print -quit)
