...
class Config:
    def __init__(self):
        ...
        self.oauth_jwt_secret = os.getenv("OAUTH_JWT_SECRET", "gitstats3-secret-key-change-in-prod")
        self.oauth_resource = os.getenv("OAUTH_RESOURCE", "gitstats3://mcp-server")
        self.oauth_issuer = os.getenv("OAUTH_ISSUER", "https://auth.gitstats3.com")
