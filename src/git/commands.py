"""
Git command execution utilities for Pecorino.
...
from src.utils.helpers import ON_LINUX
...
def getversion() -> str:
    """
    Get the pecorino version from git.
    ...
    try:
        import os.path
        pecorino_repo = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        cmd = [
            'git', f'--git-dir={pecorino_repo}/.git', f'--work-tree={pecorino_repo}',
